...
view(mtcars)
head(mtcars, 10) # preview first few lines, can specify how many lines
summary(mtcars)
...
mean(mtcars$mpg) # use $ to select a variable/column within df
# 20.09062
```
