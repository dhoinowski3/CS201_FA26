...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  ...
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Pengiun Species") + # manual colors
  theme_bw() +
  labs(title = "Palmer Pengiun Flipper Length",
       subtitle = "Three species observed on three islands in Palmer Archipelago",
       x = "Flipper Length (mm)",
       y = "Number of Pengiuns")
```
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.75) + # alpha changes transparency
  scale_fill_viridis_d(option = "magma", name = "Pengiun Species") +
  theme_bw() +
  labs(title = "Palmer Pengiun Flipper Length",
       subtitle = "Three species observed on three islands in Palmer Archipelago",
       x = "Flipper Length (mm)",
...
ggplot(data = penguins_data, aes(x = species, y = flipper_length_mm, fill = species)) +
  geom_boxplot() +
  geom_point() +
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Pengiun Species") +
...
ggplot(data = penguins_data, aes(x = culmen_depth_mm, color = species)) +
  ...
  scale_fill_viridis_d(option = "rocket", name = "Pengiun Species") +
  theme_bw() +
  labs(title = "Palmer Pengiun Culmen Depth",
       subtitle = "Three species observed on three Palmer Archipelago islands",
       x = "Culmen Depth (mm)",
       y = "Number of Pengiuns")
```
...
ggplot(data = penguins_data, aes(x = culmen_depth_mm, y = body_mass_g, color = species)) +
  ...
  labs(title = "Palmer Pengiun Culmen Depth to Body Weight",
       subtitle = "Three species observed on three Palmer Archipelago islands",
       x = "Culmen Depth (mm)",
       y = "Body Mass (G)")
```
...
scatter_plot <- ggplot(data = penguins_data, aes(x = species, y = flipper_length_mm, fill = species)) +
  geom_boxplot() +
  geom_point() +
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Pengiun Species") +
  geom_jitter(size = 0.5) +
